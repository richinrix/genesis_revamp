...
export default function ComingSoon() {
  return (
    <>
      <div className="h-screen  justify-center items-center text-center flex md:flex-row flex-col bg-black z-20">
        <h2 className="mx-12 px-12 py-5 flex  md:items-center items-end text-white  font-semibold z-10">
          {" "}
