  ...
  return (
    <div id="aboutContainer" className="h-screen w-auto">
      <div
        ...
        class="aboutContainer flex flex-col md:flex-row justify-center items-center bg-transparent h-auto md:h-full mt-20 md:px-10 sm:px-5 py-10 md:w-screen flex-shrink-0"
      >
        <div className="aboutText p-2 pr-20">
          <h1 className="aboutHead font-plantc text-5xl pb-5 pt-10">
            About Us
          </h1>
          <p className="">
        ...
        <div className="aboutImg ai1 flex-shrink-0 md:pt-10">
          <img src="https://via.placeholder.com/300x500?text=Image1"></img>
        </div>
        <div className="aboutCollage flex flex-col p-1 md:flex-shrink-0 md:pt-12 md:-pr-10">
          <div className="aboutImg ai2 md:pb-1 flex-shrink-0">
