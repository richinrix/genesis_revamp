  ...
  return (
    <div id="aboutContainer" className="h-screen w-auto">
      <div
        ...
        class="aboutContainer flex flex-col md:flex-row justify-center items-center bg-transparent h-screen  md:h-full mt-10 md:mt-20 md:px-10 sm:px-5 py-10 md:w-screen flex-shrink-0"
      >
        <div className="aboutText p-2 pr-8">
          ...
          <p className="aboutParagraphs md:mr-20 ml-5 md:ml-10 md:tracking-wider	">
            ...
            <p className="hidden md:block">
              ...
              <br /> Come join hands with us as we bring a remarkable change in
              marketing & advertising and make them accessible for businesses of
              all sizes.
            </p>
          </p>
        </div>
