...
export default function FlipContainer() {
  ...
  return (
    <div
      id="teams"
      className="  lg:h-screen 3xl:h-full  md:mb-20    flex flex-col  md:px-10 sm:px-5 3xl:pt-10 md:pt-5 pt-14 md:pb-0 pb-5  content-center justify-center proximity-snap mx-auto"
      style={{
